...
<%!
    ...
    public String buildDefaultAssertion(SAMLInputContainer input){
        try {
            ...
            confirmationMethod.setRecipient("https://srisairamengineeringcollege2.my.salesforce.com/");
            ...
            String audienceURI = "https://srisairamengineeringcollege2.my.salesforce.com/";
            ...
            int num4 = rand.nextInt(99999999);
            int num5 = rand.nextInt(999999999999);
            assertion.setID("_" + num4 + "-" + num1 + "-" + num2 + "-" + num3 + "-" + num5);
            ...
            Response res = wrapAssertionIntoResponse(assertion, "http://localhost:8085/digi/response.jsp");
...
<%
    try {
        ...
        input.setStrIssuer("http://localhost:8085/digi/response.jsp");
        input.setStrNameID("sec19cs130-e8nk@force.com");
        input.setStrNameQualifier("Digital vault");
        input.setSessionId("4567890jhv2345");
        ...
        customAttributes.put("userName", "sec19cs130-e8nk@force.com");
...
%>
        <form action="https://srisairamengineeringcollege2.my.salesforce.com/" method="post" class="text-center">
