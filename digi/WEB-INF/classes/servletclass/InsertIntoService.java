...
public class InsertIntoService extends HttpServlet {
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		String INSERT = "INSERT INTO service (servicename, serviceurl, userid) VALUES (?, ?, ?) ON CONFLICT (servicename) DO NOTHING";
		...
		try {
			...
			if (pstm2.executeUpdate() == 1) {
				if (serviceName.equals("okta")) {
					res.sendRedirect("viewapplication.jsp");
				} else {
